...
public class InvitationResource {
    ...
    @Operation(
        ...
        description = "Faz soft delete do vínculo usuário-tenant (`is_active = FALSE`), " +
            ...
            "InvitationNegocio: (1) ninguém pode remover a si mesmo; (2) o proprietário " +
    ...
    @Operation(
        ...
        description = "Cria um convite pendente (validade padrão da tabela `invitations`) " +
            ...
            "InvitationNegocio: o e-mail é normalizado (trim + lowercase); o nível de acesso " +
