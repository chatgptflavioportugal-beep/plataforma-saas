...
import com.saas.profile.service.AccessLevelService;
 ...
 * administrativas do próprio profile-service (catálogo em AccessLevelService).
 *
...
public class AccessLevelResource {
    ...
    @Operation(
        ...
        description = "Altera o `status` do nível de acesso para `ACTIVE` ou `INACTIVE` " +
            ...
            "membros/convites (a validação fica a cargo de InvitationService/AccessLevelResource " +
