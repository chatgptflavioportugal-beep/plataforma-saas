...
export function LoginPage() {
  ...
  async function onSubmit(data: LoginForm) {
    ...
    // Contas administrativas são bloqueadas pelo ClientAreaGuard após o login
    // (a área admin é o projeto frontend-admin, separado).
    navigate(returnUrl ?? '/app/dashboard', { replace: true })
  }
