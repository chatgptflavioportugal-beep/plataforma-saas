...
public class DashboardResource {
    ...
    @Inject
    DashboardNegocio dashboardNegocio;
    ...
    @Operation(
        ...
        description = "Operação exclusivamente de consulta. Tenant é resolvido via JWT do Supabase " +
            ...
            "TrialCampaignNegocio). A lista de serviços de cada módulo só é retornada para " +
    ...
    public Response getDashboardModules(@Context SecurityContext secCtx) {
        ...
        List<DashboardModuleResponse> result = dashboardNegocio.listModulesWithAccessStatus(
