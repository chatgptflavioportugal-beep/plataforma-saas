...
def mock_repository():
    ...
    with (
        patch("repository.pdf_jobs_repository.create_job", new=AsyncMock(return_value=created)),
        patch("repository.pdf_jobs_repository.complete_job", new=AsyncMock(return_value=completed)),
        patch("repository.pdf_jobs_repository.fail_job", new=AsyncMock()),
        patch("repository.pdf_jobs_repository.list_jobs", new=AsyncMock(return_value=[created])),
        patch("repository.pdf_jobs_repository.count_jobs_today", new=AsyncMock(return_value=0)),
    ):
        yield
