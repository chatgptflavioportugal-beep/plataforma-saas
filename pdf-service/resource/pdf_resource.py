...
from repository.local_storage import file_exists, read_file
...
async def merge_pdf(
    ...
    return await merge_negocio.execute(file_a, file_b, auth)
...
async def list_jobs(
    ...
    jobs = await pdf_jobs_dao.list_jobs(auth.tenant_id)
...
async def download_job(
    ...
    job = await pdf_jobs_dao.get_job(job_id, auth.tenant_id)
