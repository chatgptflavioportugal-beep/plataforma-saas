package com.saas.admin.exception.mapper;

import com.saas.admin.dto.ErrorResponse;
 ...
 * (code, message, details, timestamp, traceId) — mesmo padrão do Usage Service.
 */
@Provider
public class GenericExceptionMapper implements ExceptionMapper<Exception> {
    ...
    public Response toResponse(Exception exception) {
        ...
        LOG.error("Erro não tratado no admin-service [traceId=" + traceId + "]", exception);
