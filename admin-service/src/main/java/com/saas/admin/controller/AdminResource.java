...
public class AdminResource {
    ...
    @Inject AdminGeneralService adminGeneralService;
    ...
    public Response stats() {
        ...
        DashboardStatsDTO result = adminGeneralService.stats();
    ...
    public Response listTenants(
        ...
        List<TenantSummaryDTO> tenants = tenantService.listAdminTenants(search, status, hasExtraMembers);
    ...
    public Response getTenantDetail(
        ...
        Optional<TenantDetailDTO> detail = tenantService.getAdminTenantDetail(id);
        if (detail.isEmpty())
    ...
    public Response listCustomers(
        ...
        List<CustomerSummaryDTO> customers = adminGeneralService.listCustomers(
    ...
    public Response getCustomerDetail(
        ...
        Optional<CustomerDetailDTO> detail = adminGeneralService.getCustomerDetail(id);
        if (detail.isEmpty())
    ...
    public Response listSystemAdmins() {
        ...
        List<SystemAdminDTO> admins = adminGeneralService.listSystemAdmins();
    ...
    public Response updateTenantStatus(
        ...
        boolean updated = tenantService.updateStatus(id, status, adminAuth.currentUserId());
    ...
    public Response updateCustomerStatus(
        ...
        boolean updated = adminGeneralService.updateCustomerStatus(id, isActive, status, adminAuth.currentUserId());
