...
import com.saas.admin.service.AccessLevelService;
...
public class AdminAccessLevelsResource {
    ...
    @Inject AccessLevelService accessLevelService;
    ...
    public Response getMyPermissions() {
        ...
        List<String> perms = accessLevelService.getMyPermissionKeys(adminAuth.currentUserId());
    ...
    public Response getPermissionTree() {
        ...
        List<PermissionGroupDTO> groups = accessLevelService.getPermissionTree();
    ...
    public Response listAccessLevels(
        ...
        List<AccessLevelDTO> levels = accessLevelService.list(status);
    ...
    public Response getAccessLevel(
        ...
        Optional<AccessLevelDetailDTO> level = accessLevelService.get(id);
    ...
    public Response createAccessLevel(AccessLevelRequest req) {
        ...
        AccessLevelDetailDTO created = accessLevelService.create(
    ...
    public Response updateAccessLevel(
        ...
        Optional<List<String>> permKeys = accessLevelService.update(
    ...
    public Response updateStatus(
        ...
        if ("INACTIVE".equals(newStatus)) {
            long userCount = accessLevelService.countActiveAdminUsers(id);
            if (userCount > 0)
        ...
        boolean updated = accessLevelService.updateStatus(id, newStatus, adminAuth.currentUserId());
