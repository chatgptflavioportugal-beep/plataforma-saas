...
public class AdminFeatureFlagResource {
    ...
    public Response list() {
        ...
        List<FeatureFlagDTO> flags = featureFlagNegocio.list();
    ...
    public Response create(FeatureFlagRequest req) {
        ...
        if (featureFlagNegocio.existsByKey(req.key()))
            return Response.status(400).entity(Map.of("error", "Já existe uma feature flag com esta key")).build();

        UUID id = featureFlagNegocio.create(req, adminAuth.currentUserId());
    ...
    public Response update(
        ...
        boolean updated = featureFlagNegocio.update(id, req, adminAuth.currentUserId());
    ...
    public Response toggleStatus(
        ...
        boolean toggled = featureFlagNegocio.toggleStatus(id, adminAuth.currentUserId());
