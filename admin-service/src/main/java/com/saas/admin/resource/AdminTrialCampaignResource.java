...
public class AdminTrialCampaignResource {
    ...
    public Response listByPlan(
        ...
        List<TrialCampaignDTO> campaigns = trialCampaignNegocio.listByPlan(planId);
    ...
    public Response listAll(
        ...
        TrialCampaignPageDTO result = trialCampaignNegocio.listAll(
    ...
    public Response getDetail(
        ...
        TrialCampaignDetailDTO detail = trialCampaignNegocio.getDetail(id)
    ...
    public Response listParticipants(
        ...
        List<TrialCampaignParticipantDTO> participants = trialCampaignNegocio.listParticipants(id);
    ...
    public Response history(
        ...
        List<TrialCampaignHistoryEntryDTO> history = trialCampaignNegocio.history(id);
    ...
    public Response create(TrialCampaignRequest req) {
        ...
        var id = trialCampaignNegocio.create(req, userId);
    ...
    public Response update(
        ...
        Optional<AdminTrialCampaignNegocio.UpdateResult> result = trialCampaignNegocio.update(id, req, userId);
        AdminTrialCampaignNegocio.UpdateResult r = result
            .orElseThrow(() -> new NotFoundException("Campanha de Trial não encontrada"));
    ...
    public Response close(
        ...
        boolean closed = trialCampaignNegocio.close(id, userId);
    ...
    public Response cancel(
        ...
        boolean cancelled = trialCampaignNegocio.cancel(id, req, userId);
        if (!cancelled)
