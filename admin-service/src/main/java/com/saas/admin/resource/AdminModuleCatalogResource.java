...
public class AdminModuleCatalogResource {
    ...
    public Response listModules(
        ...
        List<PlatformModuleDTO> modules = moduleCatalogNegocio.listModules(search, isActive);
    ...
    public Response createModule(ModuleRequest req) {
        ...
        ModuleCatalogNegocio.OpResult result = moduleCatalogNegocio.createModule(req);
    ...
    public Response updateModule(
        ...
        ModuleCatalogNegocio.OpResult result = moduleCatalogNegocio.updateModule(id, req);
        return Response.status(result.status()).entity(result.body()).build();
    }
    ...
    public Response toggleModuleStatus(
        ...
        boolean updated = moduleCatalogNegocio.toggleModuleStatus(id);
    ...
    public Response listModuleServices(
        ...
        List<PlatformModuleServiceDTO> services = moduleCatalogNegocio.listServices(moduleId);
    ...
    public Response createModuleService(
        ...
        ModuleCatalogNegocio.OpResult result = moduleCatalogNegocio.createService(moduleId, req);
        return Response.status(result.status()).entity(result.body()).build();
    }
    ...
    public Response updateModuleService(
        ...
        ModuleCatalogNegocio.OpResult result = moduleCatalogNegocio.updateService(moduleId, id, req);
        return Response.status(result.status()).entity(result.body()).build();
    }
    ...
    public Response toggleModuleServiceStatus(
        ...
        boolean updated = moduleCatalogNegocio.toggleServiceStatus(moduleId, id);
    ...
    public Response listModuleServiceGroups(
        ...
        List<PlatformModuleServiceGroupDTO> groups = moduleCatalogNegocio.listServiceGroups(moduleId);
    ...
    public Response createModuleServiceGroup(
        ...
        ModuleCatalogNegocio.OpResult result = moduleCatalogNegocio.createServiceGroup(moduleId, req);
        return Response.status(result.status()).entity(result.body()).build();
    }
    ...
    public Response updateModuleServiceGroup(
        ...
        ModuleCatalogNegocio.OpResult result = moduleCatalogNegocio.updateServiceGroup(moduleId, id, req);
        return Response.status(result.status()).entity(result.body()).build();
    }
    ...
    public Response toggleModuleServiceGroupStatus(
        ...
        ModuleCatalogNegocio.OpResult result = moduleCatalogNegocio.updateServiceGroupStatus(moduleId, id, newStatus);
        return Response.status(result.status()).entity(result.body()).build();
    }
}
