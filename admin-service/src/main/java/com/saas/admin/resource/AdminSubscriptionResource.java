...
public class AdminSubscriptionResource {
    ...
    public Response getSubscriptionsSummary() {
        ...
        SubscriptionsSummaryDTO summary = adminGeneralNegocio.getSubscriptionsSummary();
    ...
    public Response listSubscriptions(
        ...
        SubscriptionPageDTO result = adminGeneralNegocio.listSubscriptions(
    ...
    public Response cancel(
        ...
        try (Response upstream = subscriptionServiceRepository.cancelSubscription(authorization, id)) {
    ...
    public Response reactivate(
            ...
            @Context HttpHeaders httpHeaders) {
        String authorization = httpHeaders.getHeaderString(HttpHeaders.AUTHORIZATION);
        try (Response upstream = subscriptionServiceRepository.reactivateSubscription(authorization, id)) {
            return Response.status(upstream.getStatus()).entity(upstream.readEntity(String.class)).build();
        }
    }
}
