...
public class AccessLevelNegocioImpl implements AccessLevelNegocio {
    ...
    public AccessLevelDetailDTO create(String name, String description, List<Object> rawPermissionKeys, String actorUserId) {
        ...
        auditNegocio.log(actorUserId, "access_level.create", "admin_access_levels", created.id(), Map.of("name", name));
        return created;
    }
    ...
    public Optional<List<String>> update(String id, String name, String description, List<Object> rawPermissionKeys, String actorUserId) {
        ...
        auditNegocio.log(actorUserId, "access_level.update", "admin_access_levels", id, Map.of("name", name));
    ...
    public boolean updateStatus(String id, String status, String actorUserId) {
        ...
        auditNegocio.log(actorUserId, "access_level.status_change", "admin_access_levels", id, Map.of("status", status));
        return true;
    }
