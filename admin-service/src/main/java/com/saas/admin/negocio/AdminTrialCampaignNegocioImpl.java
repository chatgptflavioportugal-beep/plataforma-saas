...
@ApplicationScoped
public class AdminTrialCampaignNegocioImpl implements AdminTrialCampaignNegocio {
    ...
    @Inject
    TrialCampaignAdminNegocio trialCampaignAdminNegocio;
    ...
    public UUID create(TrialCampaignRequest req, String userId) {
        ...
        // faz sentido nele. Validação de negócio fica na camada de negócio para não
        // depender só do Resource nem do que o Frontend deixa de listar.
        if (trialCampaignAdminNegocio.isFreePlanVersionModule(req.planVersionModuleId())) {
            auditNegocio.log(userId, "trial_campaign.creation_denied", "trial_campaigns",
        ...
        auditNegocio.log(userId, "trial_campaign.created", "trial_campaigns", id.toString(),
    ...
    public Optional<UpdateResult> update(String id, TrialCampaignRequest req, String userId) {
        ...
        auditNegocio.log(userId, "trial_campaign.updated", "trial_campaigns", id,
    ...
    public boolean close(String id, String userId) {
        ...
        auditNegocio.log(userId, "trial_campaign.closed", "trial_campaigns", id, null);
        return true;
    }
    ...
    public boolean cancel(String id, CancelRequest req, String userId) {
        ...
        auditNegocio.log(userId, "trial_campaign.cancelled", "trial_campaigns", id,
