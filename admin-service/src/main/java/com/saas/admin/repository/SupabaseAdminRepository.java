...
/**
 * Chamadas à Admin API do Supabase Auth usadas por AdminUsersNegocio para
 ...
 */
@ApplicationScoped
public class SupabaseAdminRepository {

    private static final Logger LOG = Logger.getLogger(SupabaseAdminRepository.class);
