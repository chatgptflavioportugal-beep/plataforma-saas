...
INSERT INTO plans (code, name, description, price_monthly, price_annual, discount_annual_percent, max_users, max_ai_requests_month, features, sort_order, version, is_current_version, billing_type, is_most_popular)
VALUES
(
    'free',
    'Free',
